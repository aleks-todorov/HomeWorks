...
//Task 4: 
module("Snake.checkIfCanibal");
test("The snake must die, when it bites itself", function () {
    var snakePossition = {
        x: 150,
        y: 150
    }
    var snake = new snakeGame.Snake(snakePossition, 8, 0);
    snake.pieces[4].position.x = snakePossition.x;
    snake.pieces[4].position.y = snakePossition.y;
    var isDead = false;
