...
class AssertionsHomework
{
    ...
    {
        Debug.Assert(arr != null, "Array is empty, provide corect data!");

        var arrLenght = arr.Length - 1;
        for (int index = 0; index < arrLenght; index++)
        {
        ...
        for (int i = 0; i < arrLenght; i++)
        {
            ...
            Debug.Assert(isSorted == false, "The array is not sorted!");
        }
    }
        ...
        where T : IComparable<T>
    {
        ...
        for (int i = startIndex + 1; i < endIndex; i++)
        {
            ...
            Debug.Assert(isSmallest == false, "The element" + arr[minElementIndex] + " is not the smallest!");
        }
