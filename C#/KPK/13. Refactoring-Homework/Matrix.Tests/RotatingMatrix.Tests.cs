...
namespace MatrixTests
{
    ...
    public class RotatingMatrixTest
    {
        ...
        [TestMethod]
        public void TestOutputMatrixWithNumberFour()
        {
            int n = 4;
            int[,] expectedMatrix =
            {
        ...
        [TestMethod]
        public void TestOutputMatrixWithNumberFive()
        {
            int n = 5;
            int[,] expectedMatrix =
            {
        ...
        [TestMethod]
        public void TestInvalidOutputMatrixWithSeven()
        {
            int n = 7;
            int[,] expectedMatrix =
            {
        ...
        [TestMethod]
        public void TestInvalidOutputMatrixWithSevenInFirstPosition()
        {
            int n = 7;
            int[,] expectedMatrix =
            {
